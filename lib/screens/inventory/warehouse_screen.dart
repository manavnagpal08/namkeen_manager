                    ...
                    builder: (context, stockSnap) {
                      ...
                      if (_searchQuery.isNotEmpty) {
                        stocks = stocks.where((s) {
                          ...
                          return pName.contains(_searchQuery) || s.batchId.toLowerCase().contains(_searchQuery);
                        }).toList();
                      }
                                    ...
                                    Expanded(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text('Batch: ${stock.batchId}', style: TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
